...
export const Portfolio = () => {
  ...
  <div id="card">
    <div className="img" />
    <div className="name">AAin ur rehman</div>
    <div className="description">
      Estudante de Análise e Desenvolvimento de Sistemas, adoro tecnologia,
      design e estou sempre aberta a aprender coisas novas. Tenho bom
